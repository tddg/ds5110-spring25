...
* **Heads-up1:** A single pretrain/fine-tune process can be time-consuming 
(taking from 40 minutes to 2 hours w/ a single CPU). 
...
question about GPT (your predefined training dataset). 
...
You should **duplicate** your `.ipynb` file from Part 2 and name it
...
**Task 3:** In this task you will launch a containerized text generation inference server
that hosts your fine-tuned model and chat with it using a web interface.
...
Having a good interface frontend is part of a good data system design. Next,
